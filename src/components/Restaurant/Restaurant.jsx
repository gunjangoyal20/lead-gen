        ...
        <div className="name_ngo_sec">
          ...
          <div class="form_first show_form">
            <div className="form_sec">
              <label className="que_head">Enter your Restaurant Name:</label>
              <br />
              <input
                id="input_block2"
                type="text"
          ...
          <div class="form_four hidden_form">
            <div className="form_sec">
              <label className="que_head">Phone Number for payment link and Order Tracking</label>
              <br />
